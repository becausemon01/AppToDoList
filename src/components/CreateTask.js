...
import PopupPriority from "../components/popup/PopupPriority";
...
class CreateTask extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            y: 0,
            project: "Inbox",
            day: moment(new Date()).format("D MMM YYYY"),
            idProject: "tan_adce3860_6c8f_7da08417f156e05d",
        };
    }
    ...
    //dua Id cua project len component Task
    onGetNameProject = (project, idProject) => {
        this.setState({
            project,
            idProject,
        });
    ...
    render() {
        ...
        let elmDate = isOpenDate && (
            <div onClick={e => e.stopPropagation()}>
                <PopupDate handleDate={this.handleDate} date={this.state.day} />
            </div>
        );
        ...
        const dateCreate =
            this.state.day === "Schedule"
                ? "Schedule"
                : moment(this.state.day).format("D MMMM");
        return (
            <ul>
