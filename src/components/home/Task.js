  ...
  render() {
    ...
    let elmOpenPopupEdit =
      this.props.isVisible && visible ? (
        <div className="popup_edit" style={myStyle}>
          <PopupEdit
          ...
          <li className="task_item">
            ...
            >
              ...
              <div className="checker">
                <div className="item_checkbox" onClick={this.onToggleTask}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
              ...
              <div className="content_task" onClick={this.onEditTask}>
                <div className="content_task_text" style={styeleComplete}>
                  <span>{task.name}</span>
                </div>
              </div>
            </div>
            ...
            <div className="display">
              <div className="modal_edit_task">
                <form className="modal_content">
                  ...
                  <div className="tabs">
                    <div role="tablist">
                      <button className="reactist" role="tab" id="tab_subtasks">
                        SubTasks
                      </button>
                      <button className="reactist" role="tab" id="tab_comment">
                        Comments
                      </button>
                      <button className="reactist" role="tab" id="tab_activity">
                        Activity
                      </button>
                    </div>
                  </div>
