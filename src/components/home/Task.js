    ...
    render (){
        ...
        return (
            ...
            <ul>
                ...
                <div className=" task_item_detail">
                    ...
                    <div className ="content_task" onClick = {this.onShowModal} >
                        <div className="content_task_text" >
                        {task.name}
                        </div>
                    </div>
                    <Modal isOpen={this.state.showModal} onRequestClose= {this.onRequestClose} shouldCloseOnOverlayClick = {false}>
                    <div>
                    <div className="display">
                        ...
                        <form className="modal_content">
                            ...
                            <button type="button" className="item_detail_close" onClick = {this.onHideModal}>
