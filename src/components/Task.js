...
import ModalBodyTask from "./popup/ModalBodyTask";
...
class Task extends Component {
    ...
    render() {
        let { task, taskEdit, projects } = this.props;

        const inFor = fn.getInForProject(projects, task.idProject);

        let date = moment(new Date()).format("D MMM");
            ...
            this.props.isVisible && visible ? (
                ...
                >
                    <PopupEdit
                        ...
                        onEditTaskPopupEdit={
                            this.props._handleSendIdToUpdateTask
                        }
                        task={task}
                    />
                </div>
                            ...
                            <ul>
                                <li className="task_item">
                                    ...
                                    >
                                        ...
                                        <div
                                            className="content_task"
                                            onClick={this.onEditTask}
                                        >
                                            <div
                                                className="content_task_text"
                                                style={styleComplete}
                                            >
                                                <span>{task.name}</span>
                                            </div>
                                            <div className="task_item_detail_bottom">
                                                <div className="td_due_day task_content_item">
                                                    <div className="due_day_control">
                                                        <span className="project_item_name1">
                                                            {task.deadLine ===
                                                            moment(
                                                                new Date()
                                                            ).format(
...
// <div
//   className="column_project task_content_item"
//   style={{ marginRight: "450px" }}
// >
//   <span className="project_item">
//     <span className="project_item_name1">
//       {task.deadLine === moment(new Date()).format("D MMM")
//         ? "Today"
//         : moment(task.deadLine).format("dddd")}
//     </span>
//   </span>
// </div>;
