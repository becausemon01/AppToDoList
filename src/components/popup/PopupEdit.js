                ...
                <div>
                  <div className="schedule_holder">
                    ...
                    <div className="icon_list">
                      <a className="icon_scheduler icon_suggestion">
                        <span>
                          <svg
                            width={28}
                            height={28}
                          ...
                          >
                            <g fill="currentColor" fillRule="nonzero">
                              ...
                              <text
                                ...
                                fontWeight={500}
                              >
                                <tspan x={14} y={18} textAnchor="middle">
                                  {moment(new Date()).add(1, "day").format("D")}
                                </tspan>
                              </text>
                            </g>
                          </svg>
                      ...
                      <a className="icon_scheduler icon_today">
                        <svg
                          width={28}
                          height={28}
                          viewBox="0 0 28 28"
                      ...
                      <a className="icon_scheduler icon_postpone">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={28}
                          height={28}
                      ...
                      <a className="icon_scheduler icon_next_week">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width={28}
                          height={28}
            ...
            <tr className="menu_item_archive menu_item">
              <td>
                <div className="menu_wrapper">
                  ...
                  <div className="menu_label">Archive task</div>
                </div>
              </td>
            </tr>
            ...
            <tr className="menu_item_move_task menu_item">
              <td>
                <div className="menu_wrapper">
                  ...
                  <div className="menu_label">Move to project</div>
                </div>
              </td>
            </tr>
            ...
            <tr className="menu_item_link menu_item">
              <td>
                <div className="menu_wrapper">
                  ...
                  <div className="menu_label">Copy link to task</div>
                </div>
              </td>
            </tr>
            <tr>
