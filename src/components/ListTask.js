            ...
            return (
                ...
                this.state.isOpenFormEdit ? (
                    ...
                    <Task
                        ...
                        index={index}
                        isVisible={
                            task.id === this.state.currTaskID ? true : false
                        }
                        _handleSendId={this._handleSendId}
                        _handleSendIdToUpdateTask={
                            this._handleSendIdToUpdateTask
                        }
                        _handleSendIdEdit={this._handleSendIdEdit}
                        onOpenFormEdit={this.onOpenFormEdit}
                        // onUpdate={this.props.onUpdate}
